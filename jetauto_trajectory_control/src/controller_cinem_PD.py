...
class PoseControl:
    def __init__(self):
        ...
        if self.guardar_datos:
            ...
            self.file_name = os.path.join(directory, f"PD_{path_type}.txt")
    ...
    def run(self):
        ...
        for i in range(0,len(self.goalx)):
            ...
            ed_x = (-self.e_x_ant + e_x)/self.tm
            ed_y = (-self.e_y_ant + e_y)/self.tm
            ed_theta = (-self.e_theta_ant + e_theta)/self.tm
            
            acx = (self.kp * e_x + self.kd*ed_x)
            acy = (self.kp * e_y + self.kd*ed_y)
            acw = (self.kp * e_theta + self.kd*ed_theta)
